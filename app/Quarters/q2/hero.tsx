        ...
        <Wrapper>
          <div className="relative">
            <div className="flex flex-col lg:flex-row justify-between items-center">
              ...
              <h1 className="lg:text-[480px] md:text-[500px] sm:text-[300px] text-[270px] text-sky-500 font-bold absolute -z-10 -top-24 lg:-top-32 md:-top-48 -left-12 md:left-10 lg:-left-16 opacity-30">Q2</h1>

          ...
          <div className='relative'>
            <div className="flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className='lg:mt-0 mt-10'>
                <h1 className="lg:text-[430px] md:text-[500px] text-[270px] text-sky-500 font-bold absolute -z-10 -top-24 lg:-top-20 md:-top-48 -left-12 md:left-10 lg:-left-10 opacity-30">Q4</h1>

            ...
            <div className="flex flex-wrap gap-x-28">
                ...
                <div className="w-full lg:w-7/12 order-last lg:order-none mt-10 lg:mt-5">
                    ...
                    <div className="flex flex-col lg:flex-row mb-10">
                        {/* Core Track */}
                        <div className="flex flex-col basis-1/2 justify-between px-9 py-12 border-4 rounded-t-lg lg:rounded-tr-none lg:rounded-l-lg border-blue-500">
                        ...
                        {/* Duration */}
                        <div className="flex flex-col basis-1/2 justify-between px-9 py-12 border-4 rounded-b-lg lg:rounded-bl-none lg:rounded-r-lg bg-blue-500 border-blue-500">
                    ...
                    <p className="text-lg mb-6 text-slate-600">
                        ...
                        <a className="text-blue-500 underline" href="https://github.com/panaverse/panaverse-template-standard">Github Link</a>
                    </p>
                    <h2 className="text-4xl font-semibold mb-6">
                ...
                <div className="lg:w-3/12 h-full">
                    <div className="border shadow-xl p-5 h-auto rounded-lg sticky">
                        ...
                        <a href="../Quarters/q1"><Quarters text="Quarter I" insideBox="Q1" /></a>
                        <a href="../Quarters/q2"><Quarters text="Quarter II" insideBox="Q2" /></a>
                        <a href="#"><Quarters text="Quarter III" insideBox="Q3" /></a>
                        <a href="../Quarters/q4"><Quarters text="Quarter IV" insideBox="Q4" /></a>
                        <a href="../Quarters/q5"><Quarters text="Quarter V" insideBox="Q5" /></a>
                    </div>
                </div>
            </div>
        </Wrapper>

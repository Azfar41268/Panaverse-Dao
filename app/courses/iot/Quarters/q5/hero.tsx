      ...
      <Wrapper>
        <div className='relative lg:pt-10'>
          <div className="flex flex-col lg:flex-row justify-between items-center">
            ...
            <h1 className="lg:text-[480px] md:text-[500px] text-[300px] text-sky-500 font-bold absolute -z-10 -top-24 lg:-top-32 md:-top-48 -left-12 md:left-10 lg:-left-10 opacity-30">Q5</h1>

...
function Hero() {
  return (
    <div className="relative h-[850px] md:h-[1050px] lg:h-[650px]">
      ...
      <Wrapper>
        <div className='relative lg:pt-10'>
          <div className="flex flex-col lg:flex-row justify-between items-center">
            {/* Content */}
            <div className='mt-10 lg:mt-0 max-w-[650px]'>
            <h1 className="lg:text-[480px] md:text-[500px] text-[300px] text-sky-500 font-bold absolute -z-10 -top-24 lg:-top-12 md:-top-48 -left-12 md:left-10 lg:-left-10 opacity-30">Q5</h1>
